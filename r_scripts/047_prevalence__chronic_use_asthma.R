...
cdm_asthma <- DrugUtilisation::generateDrugUtilisationCohortSet(
  cdm = cdm_asthma,
  name = "prevalence chronic use asthma",
...
cdm_asthma <- IncidencePrevalence::generateDenominatorCohortSet(
  cdm = cdm_asthma,
  name = "denominator_prevalence_chronic_use_asthma",
  #cohortDateRange = as.Date(c("2010-01-01", "2022-12-31")),
...
prev_chronic_use_asthma <- IncidencePrevalence::estimatePeriodPrevalence(
  cdm = cdm_asthma,
  denominatorTable = "denominator_prevalence_chronic_use_asthma",
  outcomeTable = "prevalence chronic use asthma",
...
prev_chronic_use_asthma_adj <-
  prev_chronic_use_asthma %>%
  dplyr::mutate(
...
write.csv(prev_chronic_use_asthma_adj, here::here("Macrolides/prev_chronic_use_asthma_adj.csv"))
